...
const featureIcons = [
  ...
  <rect key="vertical" x="7" y="3.5" width="10" height="17" rx="2.2" strokeLinejoin="round" />,
  <path
    key="real"
    ...
    <main className="flex flex-1 flex-col">
      <section className="flex flex-col items-center px-6 pt-20 pb-16 text-center sm:pt-28">
        ...
        >
          {landing.heroLine1}
          <br />
          <span className="text-[var(--accent)]">{landing.heroHighlight}</span>
        </h1>
